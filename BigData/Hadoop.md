...
![](../Image/Hadoop%20基础.assets/1.png)
...
![image-20211210002543711](../Image/Hadoop%20基础.assets/2.png)
...
![image-20211209140232908](../Image/Hadoop%20基础.assets/3.png)
...
结果：![image-20211209162030888](../Image/Hadoop%20基础.assets/4.png)
...
![image-20211210002455753](../Image/Hadoop%20基础.assets/5.png)
...
1. **FIFO Scheduler（先进先出调度器）：**
   ...
   ![](../Image/Hadoop%20基础.assets/6.png)
...
2. **Capacity Scheduler（容器调度器）：**
   ...
   ![](../Image/Hadoop%20基础.assets/7.png)
...
3. **Fair Scheduler（公平调度器）：**
   ...
   ![](../Image/Hadoop%20基础.assets/8.png)
...
![](../Image/Hadoop%20基础.assets/9.png)
